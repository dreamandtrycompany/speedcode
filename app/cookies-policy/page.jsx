    ...
    <div className="min-h-screen flex flex-col bg-background font-sans text-white">
      ...
      <main className="flex-grow">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          <article className="bg-background shadow-sm rounded-lg p-4 sm:p-6 lg:p-8">
            {/* Header Section */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center text-white mb-8 sm:mb-14">
              Cookies Policy for SpeedCode by DATCO
            </h1>

            {/* Metadata Section */}
            <div className="space-y-3 mb-8 sm:mb-12 text-white">
            ...
            <div className="space-y-8 sm:space-y-12">
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-base sm:text-lg text-white space-y-2 pl-4">
                  <li>
            ...
            {/* Footer Note */}
            <p className="text-base sm:text-lg text-white mt-8 sm:mt-12 text-center italic">
