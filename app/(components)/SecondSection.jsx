      ...
      <div className="flex flex-col justify-center items-center min-h-screen px-4 py-8 md:py-12 lg:py-16">
        ...
        <div className="text-left whitespace-nowrap mb-2 sm:mb-4 md:mb-6">
          <p className="font-sans font-extrabold
            ...
            <span className="flex flex-col text-shadow-white text-black sm:inline-block"><span>Code&nbsp;</span><span>with</span></span>
        ...
        <div className="text-left whitespace-nowrap">
          <p className="font-sans font-extrabold
            ...
            <span className="flex flex-col text-shadow-white text-black sm:inline-block"><span>with&nbsp;</span><span>Speed</span></span>
          </p>
        </div>
      </div>
    </section>
