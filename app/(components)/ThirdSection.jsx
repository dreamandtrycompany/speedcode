  ...
  const tiers = [
    {
      ...
      features: ['Lifetime free', 'Undisturbed coding practice', 'One language', 'Account progress tracking'],
      featured: false,
    },
    {
      name: 'Pro',
      ...
      href: '#',
      priceMonthly: '$5',
      description: 'The best plan if you want to use the full potential of our product.',
      features: [
    ...
    <section className="panel font-sans min-h-screen mb-[20vh] w-full flex justify-center items-center p-4 sm:p-6 md:p-8 bg-#black">
      <div className="relative isolate bg-black px-6 py-24 sm:py-32 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-pretty text-center text-lg font-medium text-gray-300 sm:text-xl/8">
          Choose an affordable plan that you think is more valuable and worthy to you. The differences are shown here.
        </p>
          ...
          {tiers.map((tier, tierIdx) => (
            <div
              ...
              className={classNames(
                tier.featured ? 'relative bg-[#1a1a1a] shadow-2xl' : 'bg-[#000000] sm:mx-8 lg:mx-0',
                tier.featured
                  ? ''
                  : tierIdx === 0
            ...
            >
              <h3
                id={tier.id}
                className={classNames(tier.featured ? 'text-[#29b960]' : 'text-[#29b960]', 'text-base/7 font-semibold')}
              >
                {tier.name}
              </h3>
              ...
              <p className={classNames(tier.featured ? 'text-gray-400' : 'text-gray-400', 'mt-6 text-base/7')}>
                {tier.description}
              </p>
              <ul
                role="list"
              ...
              >
                {tier.features.map((feature) => (
                  <li key={feature} className="flex gap-x-3">
                    <CheckIcon
                      aria-hidden="true"
                      className={classNames(tier.featured ? 'text-[#29b960]' : 'text-[#29b960]', 'h-6 w-5 flex-none')}
                    />
                    {feature}
                  </li>
                ))}
